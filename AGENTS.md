...
- A described `Column` is still a report elsewhere: `default` is raw catalog text whose shape differs per engine. The README's **Schema Introspection** section is the user-facing contract.
